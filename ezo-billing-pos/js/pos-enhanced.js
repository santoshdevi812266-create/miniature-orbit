...
class EnhancedPOSApp {
    ...
    async initialize() {
        ...
        // Listen for remote barcode scans from scanner phone
    ...
    async handleAddProductRequest(payload) {
        ...
        try {
            ...
            this.displayProducts();
            this.displayProductsList();
            this.showAlert(`${product.name} added by scanner request`, 'success');
        } catch (err) {
    ...
    async handleRemoteBarcodeScan(data) {
        ...
        if (product) {
            ...
            this.showAlert(`${productName || product.name} added via scanner!`, 'success');
        } else {
            this.showAlert(`Product not found: ${barcode}`, 'warning');
        }
